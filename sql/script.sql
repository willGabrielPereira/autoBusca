...
CREATE TABLE usuario(
    ...
    foto text,
    PRIMARY KEY (codigo),
    FOREIGN KEY (localidade) REFERENCES cidade(codigo)
);
CREATE TABLE veiculo(
    ...
    modelo_ano VARCHAR(45),
    valor DECIMAL(40,2),
    descricao TEXT,
    localidade INT,
    quilometragem DECIMAL(20,2),
    proprietario INT,
    foto VARCHAR(45),
    n_chassi VARCHAR(45),
    estado VARCHAR(45),
    PRIMARY KEY (codigo),
    FOREIGN KEY (localidade) REFERENCES cidade (codigo),
    FOREIGN KEY (proprietario) REFERENCES usuario (codigo)
);

 Insert Into estado (sigla,nome) Values('AC','Acre'), ('AL','Alagoas'), ('AM','Amazonas'), ('AP','Amapá'), ('BA','Bahia'), ('CE','Ceará'),
